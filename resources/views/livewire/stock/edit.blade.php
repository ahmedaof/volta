<div class="modal fade show @if ($updateModal) d-block @endif" role="dialog" id="modalbodydel" style=" background-color: #22222255;">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select wire:model="family_id" class="form-control" id="family_id">
                        ...
                        <option value="{{ $family->id }}" {{ $family->id == $family_id ? 'selected' : '' }}>{{ $family->name }}</option>
                        @endforeach
